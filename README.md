...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/skia_canvas@0.4.2/mod.ts)
...
```ts
import { createCanvas } from "https://deno.land/x/skia_canvas@0.4.2/mod.ts";
...
Check the
[API reference here](https://doc.deno.land/https/deno.land/x/skia_canvas@0.4.2/mod.ts).
